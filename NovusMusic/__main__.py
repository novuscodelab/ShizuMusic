...
import config
from NovusMusic import LOGGER, assistant, bot, call_py
from NovusMusic.modules import ALL_MODULES
...
if __name__ == "__main__":
    ...
    # 1. MongoDB
    try:
        from NovusMusic.utils.db import start_mongo
        ok = start_mongo()
        if ok:
    ...
    try:
        from NovusMusic.utils.decorators import register_block_middleware
    ...
    for mod in ALL_MODULES:
        try:
            importlib.import_module(f"NovusMusic.modules.{mod}")
    ...
    try:
        import NovusMusic.core.call  # noqa: F401
    except Exception as e:
    ...
    # 12. Watchdog
    from NovusMusic.core.watcher import watchdog
    loop.create_task(watchdog())
    LOGGER.info("Watchdog started")

    LOGGER.info("NovusMusic is running")
    ...
    LOGGER.info(" NovusMusic stopped ")
